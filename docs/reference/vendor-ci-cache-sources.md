...
This reference owns core upstream projects, action wrappers, and historical source links. Provider capabilities and their first-party blog collections live in [Providers](../providers/README.md); mechanism selection lives in the [CI strategy map](../approaches/README.md). Reviewed: 2026-09-16.
...
| [`mr-boxington`](https://github.com/jdx/mr-boxington) and [`jdx/mr-boxington-action`](https://github.com/jdx/mr-boxington-action)                                                                                      | Cargo/compiler action cache with local, GitHub Actions, or server-backed storage.                        | Current archive baseline is mbx 1.12.0 with action 1.4.0; object mode uses directory bundles, while target mode remains a distinct mechanism. |
...
| [Mr. Boxington action](https://mr-boxington.jdx.dev/github-action), [mbx 1.12.0](https://github.com/jdx/mr-boxington/releases/tag/v1.12.0), [action 1.4.0](https://github.com/jdx/mr-boxington-action/releases/tag/v1.4.0), [remote cache](https://github.com/jdx/mr-boxington/blob/v1.12.0/docs/remote-cache.md), [cache server](https://github.com/jdx/mr-boxington/blob/v1.12.0/docs/cache-server.md), [`mr-boxington-cache` v0.1.1](https://github.com/jdx/mr-boxington-cache/releases/tag/v0.1.1), [how it works](https://mr-boxington.jdx.dev/how-it-works), and [limits](https://mr-boxington.jdx.dev/limits) | Versioned action, direct-S3, and experimental server behavior; server main declared 0.2.0 on 2026-09-16, but server performance is untested here. |
