...
| [Mr. Boxington action](https://mr-boxington.jdx.dev/github-action), [mbx 1.12.0](https://github.com/jdx/mr-boxington/releases/tag/v1.12.0), [action 1.4.0](https://github.com/jdx/mr-boxington-action/releases/tag/v1.4.0), [how it works](https://mr-boxington.jdx.dev/how-it-works), and [limits](https://mr-boxington.jdx.dev/limits) | Versioned action payload and engine behavior; local 1.11.1 and controlled 1.12.0 results remain in Evidence. |
